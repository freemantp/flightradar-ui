    ...
    export default class HereMap extends Vue {
        ...
        private async loadPositions() {
            ...
            positions.forEach( (flPos, key) => {
                this.updateMarker(String(flPos.id), {lat: Number(flPos.pos.lat), lng: Number(flPos.pos.lon), heading: Number(flPos.pos.track)} as HereCoordinates);
            });            
        }
